<?php require_once('head.php');?>
  ...
  <body>
    ...
    <ul class="timeline">
      ...
      <?php
                  $ch = curl_init();
                  curl_setopt ($ch, CURLOPT_URL, 'http://www.21cssindia.com/new/workspace/webservices/content?api_key=160e64f13691a2f59d34492dc238f98e&page=coachingschedule&section_id=29');
        ...
        <li>
          <?php
                  $ch = curl_init();
                  curl_setopt ($ch, CURLOPT_URL, 'http://www.21cssindia.com/new/workspace/webservices/content?api_key=160e64f13691a2f59d34492dc238f98e&page=coachingschedule&section_id=63');
                  curl_setopt ($ch, CURLOPT_RETURNTRANSFER, true);
                  $response=curl_exec($ch);
                  curl_close ($ch);
                  $result= json_decode($response);
