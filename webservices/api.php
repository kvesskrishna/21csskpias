...
class PHP_CRUD_API {
	...
	protected function swagger($settings) {
		...
		echo '"info":{';
		echo '"title":"'.$database.'",';
		echo '"description":"Web Service API for KPIAS application - mysql data communication. Author: KVESS KRISHNA, 21CSS india ",';
		echo '"version":"1.0.0"';
		echo '},';
...
$api = new PHP_CRUD_API(array(
 	'dbengine'=>'MySQL',
 	'hostname'=>'localhost',
 	'username'=>'kpiasdot_dbUser',
 	'password'=>'frames@08W21A0541',
 	'database'=>'kpiasdot_newDB',
 	'charset'=>'utf8'
 ));
 $api->executeCommand();