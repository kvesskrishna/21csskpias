<?php require_once('head.php');?>
  ...
  <body>
    <div id="page">
        ...
        <h3 class="headtext"> Why Inter with IAS</h3>
         <hr>
    ...
    <ul class="timeline">
        <li>
          <?php
                  $ch = curl_init();
                  curl_setopt ($ch, CURLOPT_URL, 'http://www.kpias.com/webservices/content?api_key=160e64f13691a2f59d34492dc238f98e&page=whyinterias&section_id=26');
          ...
          <div class="timeline-panel" title="click me">
            <div class="timeline-heading">
             ...
             <ul style="list-style-position:outside; list-style-type: disc;">
             	<li><?php echo $section->section_content?></li>
        ...
        <li>
           <?php
                  $ch = curl_init();
                  curl_setopt ($ch, CURLOPT_URL, 'http://www.kpias.com/webservices/content?api_key=160e64f13691a2f59d34492dc238f98e&page=whyinterias&section_id=27');
                  curl_setopt ($ch, CURLOPT_RETURNTRANSFER, true);
                  $response=curl_exec($ch);
                  curl_close ($ch);
                  $result= json_decode($response);
        ...
        <li>
          <?php
                  $ch = curl_init();
                  curl_setopt ($ch, CURLOPT_URL, 'http://www.kpias.com/webservices/content?api_key=160e64f13691a2f59d34492dc238f98e&page=whyinterias&section_id=28');
                  curl_setopt ($ch, CURLOPT_RETURNTRANSFER, true);
                  $response=curl_exec($ch);
                  curl_close ($ch);
                  $result= json_decode($response);
