<?php require_once('head.php');?>
  ...
  <body>
    <div id="page">
        ...
        <h3 class="headtext"> Optional Offered </h3>
         <hr>
    ...
    <ul class="timeline">
        <li>
          <?php
                  $ch = curl_init();
                  curl_setopt ($ch, CURLOPT_URL, 'http://www.kpias.com/webservices/content?api_key=160e64f13691a2f59d34492dc238f98e&page=optionalsoffered&section_id=31');
          ...
          <div class="timeline-panel" title="click me">
            <div class="timeline-heading">
              ...
              <!-- <h4 class="timeline-title">Regular Classes</h4> -->
