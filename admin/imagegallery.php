								...
								<input type="hidden" name="action" value="creategallery">
            						<div class="modal-body">
            							...
            							<div class="form-group">
            								...
            								<div class="col-md-8">
            									<textarea name="gallery_comment"> </textarea>
            								</div>
            							</div>
			...
			<!-- PAGE CONTENT BEGINS -->
				<div class="row">
					<div class="col-md-12">
						<?php
						$ch = curl_init();  
					    curl_setopt($ch,CURLOPT_URL,'http://www.kpias.com/webservices/gallery?api_key=160e64f13691a2f59d34492dc238f98e');
					...
					<table id="dtable">
						...
						<tbody>
							...
							foreach ($result as $row) {
								...
								?>
							<tr>
								<td><a href="editgallery.php?id=<?php echo $row->gallery_id;?>"><?php echo $row->gallery_title;?></a></td>
								<td><?php echo $row->gallery_status;?></td>
								<td><?php echo $row->gallery_created;?></td>
								<td>
									<a  href="#edit<?php echo $row->gallery_id?>" data-toggle="modal"><i class="fa fa-pencil"></i></a>
								</td>
						<div id="edit<?php echo $row->gallery_id?>" class="modal fade">
							<div class="modal-dialog">
							    <div class="modal-content">
							        <div class="modal-header">
						                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
							...
							<form class="form-horizontal" method="post" enctype="multipart/form-data" action="formactions.php">
            						<div class="modal-body">
            								...
            								<label class="control-label col-md-4">Title</label>
            								<div class="col-md-8">
            									<input type="text" name="gallery_title" class="form-control" required="" value="<?php echo $row->gallery_title?>">
            								</div>
            							</div>
            							...
            							<div class="form-group">
            								<label class="control-label col-md-4">Comment</label>
            								<div class="col-md-8">
            									<textarea name="gallery_comment" ><?php echo $row->gallery_comment?></textarea>
            								</div>
            							</div>
            							...
            							<div class="form-group">
            								...
            								<div class="col-md-10">
            									<select class="form-control" name="gallery_status">
            										<option selected="" value="<?php echo $row->gallery_status?>"><?php echo $row->gallery_status?></option>
