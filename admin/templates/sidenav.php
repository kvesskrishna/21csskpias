	...
	<ul class="nav nav-list">
		...
		<li <?php if ($page=="currentaffairs") echo "class='active'";?>>
			<a href="studentzone.php?cat=currentaffairs">
				<i class="menu-icon fa fa-tachometer"></i>
				<span class="menu-text">Current Affairs (EM)</span>
			</a>

			<b class="arrow"></b>
		</li>
		<li <?php if ($page=="telugucurrentaffairs") echo "class='active'";?>>
			<a href="studentzone.php?cat=telugucurrentaffairs">
				<i class="menu-icon fa fa-tachometer"></i>
				<span class="menu-text">Current Affairs (TM)</span>
			</a>

			<b class="arrow"></b>
		</li>

		<li <?php if ($page=="telugumagazines") echo "class='active'";?>>
			<a href="studentzone.php?cat=telugumagazines">
				<i class="menu-icon fa fa-tachometer"></i>
				<span class="menu-text">Magazines (Telugu) </span>
			</a>

			<b class="arrow"></b>
		</li>
		<li <?php if ($page=="englishmagazines") echo "class='active'";?>>
			<a href="studentzone.php?cat=englishmagazines">
				<i class="menu-icon fa fa-tachometer"></i>
				<span class="menu-text">Magazines (English) </span>
			</a>
