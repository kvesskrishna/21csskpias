								...
								<input type="hidden" name="action" value="createvideo">
            						<div class="modal-body">
            							...
            							<div class="form-group">
            								...
            								<div class="col-md-8">
            									<textarea name="video_comment"> </textarea>
            								</div>
            							</div>
					...
					<table id="dtable">
						...
						<tbody>
							...
							<tr>
								...
								<td><?php echo $row->video_created;?></td>
								<td>
									<a  href="#edit<?php echo $row->video_id?>" data-toggle="modal"><i class="fa fa-pencil"></i></a>
								</td>
						<div id="edit<?php echo $row->video_id?>" class="modal fade">
							<div class="modal-dialog">
							    <div class="modal-content">
							        <div class="modal-header">
						                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
							...
							<form class="form-horizontal" method="post" enctype="multipart/form-data" action="formactions.php">
            						<div class="modal-body">
            								...
            								<label class="control-label col-md-4">Title</label>
            								<div class="col-md-8">
            									<input type="text" name="video_title" class="form-control" required="" value="<?php echo $row->video_title?>">
            								</div>
            							</div>
            							<div class="form-group">
            								<label class="control-label col-md-4">Link</label>
            								<div class="col-md-8">
            									<input type="text" name="video_link" class="form-control" required="" value="<?php echo $row->video_link?>">
            								</div>
            							</div>
            							<div class="form-group">
            								<label class="control-label col-md-4">Comment</label>
            								<div class="col-md-8">
            									<textarea name="video_comment" ><?php echo $row->video_comment?></textarea>
            								</div>
            							</div>
            							...
            							<div class="form-group">
            								...
            								<div class="col-md-10">
            									<select class="form-control" name="video_status">
            										<option selected="" value="<?php echo $row->video_status?>"><?php echo $row->video_status?></option>
